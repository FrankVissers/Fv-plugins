...
<p align="center">
This repository is a collection of all plugins made for the projects powered by Open Discord. 
...
- **🎨 customisation** - Plugins are soon able to create their own config files, translations, etc!
